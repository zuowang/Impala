...
//    static __m256i m_bit_mask = _mm256_set1_epi64x(Bitmap::BIT_INDEX_MASK);
    static __m256i m_bit_mask = _mm256_set1_epi32(31);
    //static __m128i m_bit_mask = _mm_set1_epi32(Bitmap::BIT_INDEX_MASK);
//    static __m256i m_bit_mask = _mm256_set1_epi32(Bitmap::BIT_INDEX_MASK);
//    static __m256i m_one = _mm256_set1_epi64x(1LL);
    static __m256i m_one = _mm256_set1_epi32(1);
//    __m128i m_bit_index = _mm_loadu_si128(reinterpret_cast<const __m128i*>(bit_index));
//    __m128i m_bit_index;
//    __m256i m_bit_index;
    __m256i m_bit_index;
    if (mod) {
...
//      m_bit_index = _mm_set_epi32(bit_index[1] % num_bits_, bit_index[0] % num_bits_,
//        bit_index[3] % num_bits_, bit_index[2] % num_bits_);
//      m_bit_index = _mm256_set_epi64x(bit_index[1] % num_bits_, bit_index[0] % num_bits_,
//        bit_index[3] % num_bits_, bit_index[2] % num_bits_);
//      m_bit_index = _mm256_loadu_si256(reinterpret_cast<const __m256i*>(bit_index));

//      static __m256d reciprocal = _mm256_set1_pd((double)1 / num_bits_);
//      __m256d t1 = _mm256_cvtepi32_pd(m_bit_index);
//      __m256d t2 = _mm256_mul_pd(t1, reciprocal);
//      __m128i t3 = _mm256_cvtpd_epi32(t2);
//      static __m128i m_num_bits = _mm_set1_epi32(num_bits_);
//      __m128i t4 = _mm_mul_epi32(t3, m_num_bits);
//      m_bit_index = _mm_sub_epi32(m_bit_index, t4);
    } else {
//      m_bit_index = _mm_loadu_si128(reinterpret_cast<const __m128i*>(bit_index));
//      m_bit_index = _mm256_loadu_si256(reinterpret_cast<const __m256i*>(bit_index));
      m_bit_index = _mm256_loadu_si256(reinterpret_cast<const __m256i*>(bit_index));
    }
...
//    __m256i m_word_index = _mm256_srli_epi32(m_bit_index, NUM_OFFSET_BITS);
//    __m256i m_words = _mm256_i64gather_epi64(
//        reinterpret_cast<const long long int*>(&buffer_[0]), m_word_index, 8);
//    m_bit_index = _mm256_and_si256(m_bit_index, m_bit_mask);
//    __m256i m_masks = l_mm256_sllv_epi64(m_one, m_bit_index);
//    __m256i m_result = _mm256_and_si256(m_words, m_masks);
//    _mm256_storeu_si256(reinterpret_cast<__m256i*>(result), m_result);
  }
#endif
 ...
 private:
  ...
  int64_t num_bits_;
//  static const __m256i m_one;
//  static const __m256i m_bit_mask;
